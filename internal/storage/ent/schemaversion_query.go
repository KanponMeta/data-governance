...
func (svq *SchemaVersionQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (svq *SchemaVersionQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (svq *SchemaVersionQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (svq *SchemaVersionQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (svq *SchemaVersionQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (svq *SchemaVersionQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := svq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(schemaversion.FieldAsset).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.SchemaVersion.Query().
//		Select(schemaversion.FieldAsset).
//		Scan(ctx, &v)
...
func (svq *SchemaVersionQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(schemaversion.Table, schemaversion.Columns, sqlgraph.NewFieldSpec(schemaversion.FieldID, field.TypeUUID))
	_spec.From = svq.sql
