...
func (sq *SensorQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (sq *SensorQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (sq *SensorQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (sq *SensorQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (sq *SensorQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (sq *SensorQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := sq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (sq *SensorQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(sensor.Table, sensor.Columns, sqlgraph.NewFieldSpec(sensor.FieldID, field.TypeUUID))
	_spec.From = sq.sql
